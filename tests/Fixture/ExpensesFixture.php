...
class ExpensesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'item_number' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'item_cost' => 1.5,
                'quantity' => 1,
                'item_date' => '2020-01-06 20:40:00',
                'date_modified' => '2020-01-06 20:40:00',
                'date_added' => '2020-01-06 20:40:00'
            ],
        ];
        parent::init();
    }
